...
public class SmartPlugContentDefine {
	...
	public final static class ControlAction implements BaseColumns {
		...
		public final static String TABLE_CREATE = "CREATE TABLE IF NOT EXISTS "
				+ TABLE_NAME + " (" + _ID
				+ " integer primary key autoincrement, " + DIRECTION
				+ " integer default 0," + ACTION_CODE + " integer default 0,"
				+ ACTION_STRING + " text default ''," + ACTION_TIME
				+ " long default 0," + RECEIVE_TYPE + " integer default 0,"
				+ RECEIVE_VALUE + " text default ''," + RESERVE_1
				+ " text default ''," + RESERVE_2 + " text default '',"
	...
	public final static class User implements BaseColumns {
		...
		public final static String TABLE_CREATE = "CREATE TABLE IF NOT EXISTS "
				...
				+ " text default ''," + USER_PWD + " text default '',"
				+ PWD_KEEP + " bit default 0," + LOGIN_MODE + " bit default 0,"
				+ PWD_FIND_EMAIL + " text default '');";

		public static final String TRIGGER_USER_DELETE = "Trigger_Users";
		public final static String SQL_TRIGER_USER_DELETE = " CREATE TRIGGER ["
				+ TRIGGER_USER_DELETE + "]" + " AFTER DELETE ON [" + TABLE_NAME
				+ "]" + " BEGIN" + " delete from "
				+ SmartPlugContent.TABLE_NAME + " where "
				+ SmartPlugContent.USER_NAME + " = old." + USER_NAME + ";"
				+ " END;";
	}
	...
	public final static class SmartPlugContent implements BaseColumns {
		...
		public final static String TABLE_CREATE = "CREATE TABLE IF NOT EXISTS "
				...
				+ PLUG_STATUS + " int default 0," + PLUG_FLASHMODE
				+ " int default 0," + PLUG_COLOR_R + " int default 255,"
				+ PLUG_COLOR_G + " int default 255," + PLUG_COLOR_B
				+ " int default 255," + PLUG_PROTOCOLMODE + " int default 1,"
				+ PLUG_VERSION + " text default ''," + PLUG_MAC
				+ " text default ''," + PLUG_TYPE + " text default '',"
				+ CURTAIN_POSITION + " int default 0," + RESERVE_2
				+ " text default '');";

		public static final String TRIGGER_USER_DELETE = "Trigger_Timers";
		public final static String SQL_TRIGER_TIMER_DELETE = " CREATE TRIGGER ["
				+ TRIGGER_USER_DELETE
				+ "]"
				+ " AFTER DELETE ON ["
				+ TABLE_NAME
				...
				+ " BEGIN"
				+ " delete from "
				+ SmartPlugTimer.TABLE_NAME
				+ " where "
				+ SmartPlugTimer.PLUG_ID
				+ " = old."
				+ PLUG_ID
				+ ";" + " END;";
	...
	public final static class SmartPlugIRScene implements BaseColumns {
		...
		public final static String TABLE_CREATE = "CREATE TABLE IF NOT EXISTS "
				+ TABLE_NAME + " (" + _ID
				+ " integer primary key autoincrement, " + IRSCENE_ID
				+ " integer default 0," + PLUG_ID + " text default '',"
				+ IRSCENE_POWER + " integer default 0," + IRSCENE_MODE
				+ " integer default 0," + IRSCENE_DIRECTION
				+ " integer default 0," + IRSCENE_SCALE + " integer default 0,"
				+ IRSCENE_TEMPERATURE + " integer default 0," + IRSCENE_TIME
				+ " text default ''," + IRSCENE_PERIOD + " text default '',"
				+ IRSCENE_IRNAME + " text default ''," + IRSCENE_ENABLE
				+ " integer default 0);";

		public final static String DEFAULT_SORT_ORDER = _ID + " desc";
	}

	public final static class SmartPlugScene implements BaseColumns {
		public static final String AUTHORITY = "com.thingzdo.smartplugsceneprovider";

		public static final String ALL_RECORD = "smartplugscenes";
		public static final String ONE_RECORD = "smartplugscene";
		...
		// ����������Ϣ���ݱ�����
		public static final String TABLE_NAME = "SmartPlugsScenes";

		// �ֶ�����������
		public static final String SCENE_ID = "SceneId";
		public static final String SCENE_NAME = "SceneName";

		public static final String SCENE_POWER_ENABLE = "PowerEnable";
		public static final String SCENE_POWER_MODULEID = "PowerModuleID";
		public static final String SCENE_POWER_STATUS = "PowerStatus";

		public static final String SCENE_CURTAIN_ENABLE = "CurtainEnable";
		public static final String SCENE_CURTAIN_MODULEID = "CurtainModuleID";
		public static final String SCENE_CURTAIN_STATUS = "CurtainStatus";

		public static final String SCENE_AIRCON_ENABLE = "AirConEnable";
		public static final String SCENE_AIRCON_MODULEID = "AirConModuleID";
		public static final String SCENE_AIRCON_STATUS = "AirConStatus";
		public static final String SCENE_AIRCON_TEMPERATURE = "AirConTemperature";

		public static final String SCENE_PC_ENABLE = "PCEnable";
		public static final String SCENE_PC_MODULEID = "PCModuleID";
		public static final String SCENE_PC_MAC_MODULEID = "PC_Mac_ModuleID";
		public static final String SCENE_PC_MAC_ADDRESS = "PC_Mac_Address";
		public static final String SCENE_PC_STATUS = "PCStatus";

		// �� ����ֵ
		public static final int ID_COLUMN = 0;
		public static final int SCENE_ID_COLUMN = 1;
		public static final int SCENE_NAME_COLUMN = 2;

		public static final int SCENE_POWER_ENABLE_COLUMN = 3;
		public static final int SCENE_POWER_MODULEID_COLUMN = 4;
		public static final int SCENE_POWER_STATUS_COLUMN = 5;

		public static final int SCENE_CURTAIN_ENABLE_COLUMN = 6;
		public static final int SCENE_CURTAIN_MODULEID_COLUMN = 7;
		public static final int SCENE_CURTAIN_STATUS_COLUMN = 8;

		public static final int SCENE_AIRCON_ENABLE_COLUMN = 9;
		public static final int SCENE_AIRCON_MODULEID_COLUMN = 10;
		public static final int SCENE_AIRCON_STATUS_COLUMN = 11;
		public static final int SCENE_AIRCON_TEMPERATURE_COLUMN = 12;

		public static final int SCENE_PC_ENABLE_COLUMN = 13;
		public static final int SCENE_PC_MODULEID_COLUMN = 14;
		public static final int SCENE_PC_MAC_MODULEID_COLUMN = 15;
		public static final int SCENE_PC_MAC_ADDRESS_COLUMN = 16;
		public static final int SCENE_PC_STATUS_COLUMN = 17;

		public final static String TABLE_CREATE = "CREATE TABLE IF NOT EXISTS "
				+ TABLE_NAME + " (" + _ID
				+ " integer primary key autoincrement, " + SCENE_ID
				+ " integer default 0," + SCENE_NAME + " text default '',"
				+ SCENE_POWER_ENABLE + " integer default 0,"
				+ SCENE_POWER_MODULEID + " text default '',"
				+ SCENE_POWER_STATUS + " integer default 0,"
				+ SCENE_CURTAIN_ENABLE + " integer default 0,"
				+ SCENE_CURTAIN_MODULEID + " text default '',"
				+ SCENE_CURTAIN_STATUS + " integer default 0,"
				+ SCENE_AIRCON_ENABLE + " integer default 0,"
				+ SCENE_AIRCON_MODULEID + " text default '',"
				+ SCENE_AIRCON_STATUS + " integer default 0," + SCENE_PC_ENABLE
				+ " integer default 0," + SCENE_PC_MODULEID
				+ " text default ''," + SCENE_PC_MAC_MODULEID
				+ " text default ''," + SCENE_PC_MAC_ADDRESS
				+ " text default ''," + SCENE_PC_STATUS
				+ " integer default 0);";
	...
	// ������ʱ����
	public final static class SmartPlugGrowLightTimerCurve
			implements
				BaseColumns {
		public static final String AUTHORITY = "com.thingzdo.smartpluggrowlighttimerCurveprovider";

		public static final String ALL_RECORD = "smartpluggrowlighttimercurves";
		public static final String ONE_RECORD = "smartpluggrowlighttimercurve";
		...
		// ����������Ϣ���ݱ�����
		public static final String TABLE_NAME = "SmartPlugsGrowLightTimerCurves";
		...
		public static final String PLUG_LIGHT04 = "Light04";
		public static final String PLUG_LIGHT05 = "Light05";
		public static final String PLUG_LIGHT_LUSHU = "LightLushu";
		...
		public static final int PLUG_LIGHT04_COLUMN = 11;
		public static final int PLUG_LIGHT05_COLUMN = 12;
		public static final int PLUG_LIGHT_LUSHU_COLUMN = 13;
		...
		public final static String TABLE_CREATE = "CREATE TABLE IF NOT EXISTS "
				...
				+ PLUG_LIGHT02 + " integer default 0," + PLUG_LIGHT03
				+ " integer default 0," + PLUG_LIGHT04 + " integer default 0,"
				+ PLUG_LIGHT05 + " integer default 0," + PLUG_LIGHT_LUSHU
				+ " integer default 0);";
	 ...
	 * "com.thingzdo.smartpluguserviewprovider";
	 * 
	 * //view name public static final String VIEW_USER_SMARTPLUG =
	 * "view_user_smartplug";
	 * 
	 * public static final String ALL_RECORD = "view_user_smartplugs"; public
	 * static final String ONE_RECORD_ID = "view_user_smartplug_id";
	 * 
	 * //define Content's Uri public static final Uri ALL_CONTENT_URI =
	 * Uri.parse("content://" + AUTHORITY + "/" + ALL_RECORD); public static
	 * final Uri ID_CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/" +
	 * ONE_RECORD_ID);
	 * 
	 * //�ֶ����������� public static final String USER_NAME = "UserName"; public
	 * static final String PLUG_ID = "PlugId"; public static final String
	 * PLUG_NAME = "Name"; public static final String PLUG_TIMER = "HasTimer";
	 * public static final String PLUG_PERIOD = "Period"; public static final
	 * String PLUG_BEGINTIME = "BeginTime"; public static final String
	 * PLUG_ENDTIME = "EndTime"; public static final String PLUG_IP = "IP";
	 * public static final String PLUG_ONLINE = "Online"; public static final
	 * String PLUG_POWERON = "PowerOn"; public static final String RESERVE_1 =
	 * "Reserve1"; public static final String RESERVE_2 = "Reserve2";
	 * 
	 * //�� ����ֵ public static final int ID_COLUMN = 0; public static final int
	 * USER_NAME_COLUMN = 1; public static final int PLUG_ID_COLUMN = 2; public
	 * static final int PLUG_NAME_COLUMN = 3; public static final int
	 * PLUG_TIMER_COLUMN = 4; public static final int PLUG_PERIOD_COLUMN = 5;
	 * public static final int PLUG_BEGINTIME_COLUMN = 6; public static final
	 * int PLUG_ENDTIME_COLUMN = 7; public static final int PLUG_IP_COLUMN = 8;
	 * public static final int PLUG_ONLINE_COLUMN = 9; public static final int
	 * PLUG_POWERON_COLUMN = 10; public static final int RESERVE_1_COLUMN = 11;
	 * public static final int RESERVE_2_COLUMN = 12;
	 * 
	 * public static final String VIEW_USER_SMARTPLUG_CREATE =
	 * "CREATE VIEW IF NOT EXISTS " + VIEW_USER_SMARTPLUG +" AS select " +
	 * Contacts.TABLE_CONTACTS + "." + Contacts.ID + " as " + CONTACT_ID + ", "
	 * + Contacts.TABLE_CONTACTS + "." + Contacts.NAME + " as " + CONTACT_NAME +
	 * ", " + Contacts.TABLE_CONTACTS + "." + Contacts.PHOTO + " as " +
	 * CONTACT_PHOTO + ", " + Contacts.TABLE_CONTACTS + "." +
	 * Contacts.ACCOUNT_NAME + " as " + ACCOUNT_NAME + "," +
	 * Contacts.TABLE_CONTACTS + "." + Contacts.ACCOUNT_TYPE + " as " +
	 * ACCOUNT_TYPE + "," + Contacts.TABLE_CONTACTS + "." + Contacts.SORT_KEY +
	 * " as " + SORT_KEY + "," + Raw_Contacts.TABLE_RAW_CONTACTS + "." +
	 * Raw_Contacts.PHONE_NUMBER + " as " + CONTACT_PHONE_NUMBER + "," +
	 * Raw_Contacts.TABLE_RAW_CONTACTS + "." + Raw_Contacts.PHONE_TYPE + " as "
	 * + CONTACT_PHONE_TYPE + " from " + Raw_Contacts.TABLE_RAW_CONTACTS +
	 * " left join " + Contacts.TABLE_CONTACTS + " on " +
	 * Raw_Contacts.TABLE_RAW_CONTACTS + "." + Raw_Contacts.CONTACT_ID + " = " +
	 * Contacts.TABLE_CONTACTS + "." + Contacts.ID;
	 * 
	 * 
