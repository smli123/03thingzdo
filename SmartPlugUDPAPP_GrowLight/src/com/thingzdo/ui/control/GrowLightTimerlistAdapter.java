...
public class GrowLightTimerlistAdapter extends BaseAdapter {

	private ArrayList<GrowLightTimerDefine> mTasklist = null;
	...
	public GrowLightTimerlistAdapter(Context context, String plugId,
			String plugIp, ArrayList<GrowLightTimerDefine> taskList,
			Handler handler, boolean isOnline) {
		mContext = context;
	...
	private class ViewHolder {
		...
		public RelativeLayout rl_blank;
		...
		public void ViewData(GrowLightTimerDefine task, int position) {
			if (task != null) {
				...
				switch (task.mType) {
					case PubDefine.TIMER_TYPE_POWER :
						...
						img_timer_stop.setVisibility(View.GONE);
						txtTaskEnd.setVisibility(View.GONE);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (holder != null && mTasklist != null && position < mTasklist.size()) {
			GrowLightTimerDefine timer = mTasklist.get(position);
