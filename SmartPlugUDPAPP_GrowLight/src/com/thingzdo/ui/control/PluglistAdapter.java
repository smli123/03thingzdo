...
public class PluglistAdapter extends BaseAdapter {
		...
		public void ViewData(SmartPlugDefine plug, int position) {
			if (plug != null) {
				...
				if (!TextUtils.isEmpty(plug.mPlugId)) {
					...
					// PC模拟器 关机棒软件
					if (plug.mSubDeviceType == PubDefine.DEVICE_SMART_SIMULATION_PC
							&& plug.mSubProductType == PubDefine.PRODUCT_PLUG) { // 7_1
					...
					if (true == plug.mIsOnline) {
						...
						if (true == ((plug.mDeviceStatus & 1) == 1)) {
							...
							setImageRes(imgPower,
									R.drawable.smp_power_off_small);
						}
						if (true == ((plug.mDeviceStatus & 2) == 2)) {
							setImageRes(imgLight, R.drawable.smp_light_on_small);
						} else {
							setImageRes(imgLight,
									R.drawable.smp_light_off_small);
						}
						...
						if (true == ((plug.mDeviceStatus & 8) == 8)) {
							setImageRes(imgParent,
									R.drawable.smp_parentctrl_active_small);
						} else {
							setImageRes(imgParent,
									R.drawable.smp_parentctrl_deactive_small);
						}
						if (true == ((plug.mDeviceStatus & 16) == 16)) {
							setImageRes(imgPower2,
									R.drawable.smp_power_on_small);
						} else {
							setImageRes(imgPower2,
									R.drawable.smp_power_off_small);
						}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (holder != null && mPluglist != null && position < mPluglist.size()) {
			...
			if (FavoriteItem.mSubDeviceType == PubDefine.DEVICE_SMART_BATTERY
					&& FavoriteItem.mSubProductType == PubDefine.PRODUCT_PLUG) { // 8_1
			...
			} else if (FavoriteItem.mSubDeviceType == PubDefine.DEVICE_SMART_SIMULATION_PC
					&& FavoriteItem.mSubProductType == PubDefine.PRODUCT_PLUG) { // 7_1
				holder.imgLight.setVisibility(View.GONE);
				holder.imgUsb.setVisibility(View.GONE);
				holder.imgParent.setVisibility(View.GONE);
				holder.imgPower2.setVisibility(View.GONE);
			...
			} else if (FavoriteItem.mSubDeviceType == PubDefine.DEVICE_SMART_SWITCH
					&& FavoriteItem.mSubProductType == PubDefine.PRODUCT_PLUG) { // 5_1
				holder.imgLight.setVisibility(View.GONE);
				holder.imgUsb.setVisibility(View.GONE);
				holder.imgParent.setVisibility(View.GONE);
				holder.imgPower2.setVisibility(View.GONE);
			} else if (FavoriteItem.mSubDeviceType == PubDefine.DEVICE_SMART_SWITCH
					&& FavoriteItem.mSubProductType == PubDefine.PRODUCT_SMART_PLUG_AIRCON) { // 5_2
				holder.imgLight.setVisibility(View.GONE);
				holder.imgUsb.setVisibility(View.GONE);
				holder.imgParent.setVisibility(View.GONE);
				holder.imgPower2.setVisibility(View.VISIBLE);
			} else if ((FavoriteItem.mSubDeviceType == PubDefine.DEVICE_SMART_PLUG && FavoriteItem.mSubProductType == PubDefine.PRODUCT_PLUG)
					|| (FavoriteItem.mSubDeviceType == PubDefine.DEVICE_SMART_PLUG_BOARD)) { // 1_1,
																								// 2_
			...
			} else if (FavoriteItem.mSubDeviceType == PubDefine.DEVICE_SMART_PLUG
					&& FavoriteItem.mSubProductType == PubDefine.PRODUCT_SMART_PLUG_AIRCON) { // 1_2
				holder.imgPlug.setImageResource(R.drawable.smp_plug_small);
				holder.imgPower2.setVisibility(View.GONE);
			} else if (FavoriteItem.mSubDeviceType == PubDefine.DEVICE_SMART_PLUG
					&& FavoriteItem.mSubProductType == PubDefine.PRODUCT_SMART_PLUG_ENERGE) { // 1_3
				holder.imgPlug.setImageResource(R.drawable.smp_plug_small);
				holder.imgPower2.setVisibility(View.GONE);
			} else if (FavoriteItem.mSubDeviceType == PubDefine.DEVICE_SMART_STEELYARD
					&& FavoriteItem.mSubProductType == PubDefine.PRODUCT_PLUG) { // 10_1
				holder.imgPlug.setImageResource(R.drawable.smp_steelyard_small);
				holder.imgPower.setVisibility(View.GONE);
				holder.imgLight.setVisibility(View.GONE);
				holder.imgUsb.setVisibility(View.GONE);
				holder.imgParent.setVisibility(View.GONE);
				holder.imgTimer.setVisibility(View.GONE);
				holder.imgPower2.setVisibility(View.GONE);
			} else if (FavoriteItem.mSubDeviceType == PubDefine.DEVICE_SMART_CAR
					&& FavoriteItem.mSubProductType == PubDefine.PRODUCT_PLUG) { // 11_1
				holder.imgPlug.setImageResource(R.drawable.smp_smartcar_small);
				holder.imgPower.setVisibility(View.GONE);
				holder.imgLight.setVisibility(View.GONE);
				holder.imgUsb.setVisibility(View.GONE);
				holder.imgParent.setVisibility(View.GONE);
				holder.imgTimer.setVisibility(View.GONE);
				holder.imgPower2.setVisibility(View.GONE);
			} else if (FavoriteItem.mSubDeviceType == PubDefine.DEVICE_SMART_GROWLIGHT
					&& FavoriteItem.mSubProductType == PubDefine.PRODUCT_PLUG) { // 12_1
				holder.imgPlug.setImageResource(R.drawable.smp_growlight_small);
				holder.imgPower.setVisibility(View.GONE);
				holder.imgLight.setVisibility(View.GONE);
				holder.imgUsb.setVisibility(View.GONE);
				holder.imgParent.setVisibility(View.GONE);
	...
	View.OnClickListener selectPlugClick = new View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			if ((mPlug.mSubDeviceType == PubDefine.DEVICE_SMART_PLUG && mPlug.mSubProductType == PubDefine.PRODUCT_PLUG)
					|| (mPlug.mSubDeviceType == PubDefine.DEVICE_SMART_PLUG_BOARD)) { // 1_1,
																						// 2_
			...
			} else if (mPlug.mSubDeviceType == PubDefine.DEVICE_SMART_CAR
					&& mPlug.mSubProductType == PubDefine.PRODUCT_PLUG) { // 11_1
				intent.setClass(mContext, DetailSmartCarActivity.class);
			} else if (mPlug.mSubDeviceType == PubDefine.DEVICE_SMART_GROWLIGHT
					&& mPlug.mSubProductType == PubDefine.PRODUCT_PLUG) { // 12_1
				intent.setClass(mContext, DetailGrowLightActivity.class);
			} else {
				return;
			}
