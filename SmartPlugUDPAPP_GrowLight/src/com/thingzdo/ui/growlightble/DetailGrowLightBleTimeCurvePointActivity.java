...
public class DetailGrowLightBleTimeCurvePointActivity
		extends
			DetailGrowLightBleBase implements OnClickListener {
	...
	private BroadcastReceiver mDetailRev = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			// DetailGrowLightBleTimeCurvePointActivity.this, intent)) {
			// updateUI();
			// }
			// }
			//
	...
	private void queryAllTimeCurvePoint() {
		...
		// .getString(R.string.smartplug_growlight_querytimecurve),
		// true);
		// mProgress.show();
	...
	class QueryTimeCurvePoint implements Runnable {
		...
		public void run() {
			...
			// mContext,
			// DetailGrowLightTimeCurvePointActivity.this
			// .getString(R.string.smartplug_growlight_querytimecurve), true);
			// mProgress.show();
		...
		switch (view.getId()) {
			...
			case R.id.titlebar_rightbutton :
				...
				if (btn_TitleRight.getText().equals(
					...
					intent.setClass(
							DetailGrowLightBleTimeCurvePointActivity.this,
	...
	private void timecurve_add() {
		...
		intent.setClass(DetailGrowLightBleTimeCurvePointActivity.this,
				DetailGrowLightBlePointActivity.class);
		startActivity(intent);
	}
