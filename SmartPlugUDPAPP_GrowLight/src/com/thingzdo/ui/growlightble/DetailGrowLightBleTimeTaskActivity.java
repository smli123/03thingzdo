...
import com.thingzdo.ui.control.GrowLightTimerlistAdapter;
import com.thingzdo.ui.control.PlugDetailInfoActivity;
import com.thingzdo.ui.manage.AddSocketActivity2;
import com.thingzdo.ui.smartplug.PubStatus;
import com.thingzdo.ui.smartplug.SmartPlugApplication;

public class DetailGrowLightBleTimeTaskActivity extends DetailGrowLightBleBase
		implements
			OnClickListener {
	...
	private BroadcastReceiver mDetailRev = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			// DetailGrowLightBleTimeTaskActivity.this, intent)) {
			// updateUI();
			// }
			// }
	...
	OnClickListener addTimerClick = new OnClickListener() {
		...
		public void onClick(View view) {
				...
				if (null != mTimerHelper.getAllTimer(mPlug.mPlugId)) {
					...
					if (10 <= count) {
						PubFunc.thinzdoToast(
								DetailGrowLightBleTimeTaskActivity.this,
								DetailGrowLightBleTimeTaskActivity.this
			...
			intent.setClass(DetailGrowLightBleTimeTaskActivity.this,
					DetailGrowLightBleTimerActivity.class);
	...
	private void init() {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View v, int pos,
				...
				DetailGrowLightBleTimeTaskActivity.this.startActivity(intent);
		...
		SwipeMenuCreator creator = new SwipeMenuCreator() {
			...
			public void create(SwipeMenu menu) {
				...
				deleteItem.setBackground(new ColorDrawable(Color.rgb(0xF9,
						0x3F, 0x25)));
				// set item width
				WindowManager wm = (WindowManager) DetailGrowLightBleTimeTaskActivity.this
