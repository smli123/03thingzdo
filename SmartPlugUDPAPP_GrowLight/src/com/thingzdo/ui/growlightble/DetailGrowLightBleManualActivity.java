...
public class DetailGrowLightBleManualActivity extends DetailGrowLightBleBase
		implements
			OnClickListener,
	...
	private BroadcastReceiver mDetailRev = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			// DetailGrowLightBleManualActivity.this, intent)) {
			// updateUI();
			// }
			// }
	...
	public void onClick(View view) {
		...
		switch (view.getId()) {
			...
			case R.id.titlebar_rightbutton :
				...
				// intent.setClass(DetailGrowLightBleManualActivity.this,
