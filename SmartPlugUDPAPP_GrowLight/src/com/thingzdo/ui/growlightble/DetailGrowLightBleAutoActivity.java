...
public class DetailGrowLightBleAutoActivity extends DetailGrowLightBleBase
		implements
			OnClickListener {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (intent.getAction().equals(PubDefine.PLUG_NOTIFY_ONLINE)) {
				if (true == NotifyProcessor.onlineNotify(
						DetailGrowLightBleAutoActivity.this, intent)) {
					updateUI();
				}
			}
	...
	public void onClick(View view) {
		...
		switch (view.getId()) {
			...
			case R.id.titlebar_rightbutton :
				...
				// intent.setClass(DetailGrowLightBleAutoActivity.this,
	...
	private void do_commit() {
		...
		// DetailGrowLightBleAutoActivity.this,
