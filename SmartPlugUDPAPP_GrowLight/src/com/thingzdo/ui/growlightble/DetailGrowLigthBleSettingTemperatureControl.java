...
public class DetailGrowLigthBleSettingTemperatureControl
		extends
			DetailGrowLightBleBase
		implements
			OnClickListener,
	...
	private BroadcastReceiver mDetailRev = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			// DetailGrowLigthBleSettingTemperatureControl.this, intent)) {
			// updateUI();
			// }
			// }
	...
	public void onClick(View view) {
		...
		switch (view.getId()) {
			...
			case R.id.titlebar_rightbutton :
				...
				// intent.setClass(
				// DetailGrowLigthBleSettingTemperatureControl.this,
