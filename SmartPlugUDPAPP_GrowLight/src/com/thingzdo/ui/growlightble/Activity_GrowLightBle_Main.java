 ...
 * **/
/**
 * @Description: TODO<Activity_GrowLightBle_Main类实现打开蓝牙、扫描蓝牙>
 * @author 广州汇承信息科技有限公司
 * @data: 2014-10-12 上午10:28:18
 * @version: V1.0
 */
@SuppressLint("NewApi")
public class Activity_GrowLightBle_Main extends Activity
		implements
			OnClickListener {
	// 扫描蓝牙按钮
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_growlight_ble_main);
		// 初始化控件
		init();
		// 初始化蓝牙
		init_ble();
		...
		lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View v, int position,
				...
				final Intent intent = new Intent(
						Activity_GrowLightBle_Main.this,
						Activity_GrowLightBle_Control.class);
				intent.putExtra(
						Activity_GrowLightBle_Control.EXTRAS_DEVICE_NAME,
						device.getName());
				intent.putExtra(
						Activity_GrowLightBle_Control.EXTRAS_DEVICE_ADDRESS,
						device.getAddress());
				intent.putExtra(
						Activity_GrowLightBle_Control.EXTRAS_DEVICE_RSSI, rssis
				...
				try {
					// 启动Activity_GrowLightBle_Control
	...
	private class LeDeviceListAdapter extends BaseAdapter {
		...
		public View getView(int i, View view, ViewGroup viewGroup) {
			...
			// 加载listview每一项的视图
			view = mInflator.inflate(R.layout.activity_growlight_ble_listitem,
					null);
			// 初始化三个textview显示蓝牙信息
