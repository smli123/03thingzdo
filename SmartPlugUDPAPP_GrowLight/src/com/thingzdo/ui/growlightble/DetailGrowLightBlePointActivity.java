...
public class DetailGrowLightBlePointActivity extends DetailGrowLightBleBase
		implements
			OnClickListener,
	...
	private BroadcastReceiver mDetailRev = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			// DetailGrowLightBlePointActivity.this, intent)) {
			// updateUI();
			// }
			// }
	...
	private void showDialog(TextView view, String timer) {
		...
		ScreenInfo screenInfo = new ScreenInfo(
				DetailGrowLightBlePointActivity.this);
