...
import com.thingzdo.ui.control.DetailGrowLightActivity;
...
public class AddSocketActivity2 extends TitledActivity
		...
		public void handleMessage(Message msg) {
			...
			if (msg.what == 0) {
				...
				if (PubDefine.g_Connect_Mode == PubDefine.SmartPlug_Connect_Mode.Shake
						&& 0 == listData.size()) {
					new MyAlertDialog(AddSocketActivity2.this)
							.builder()
							.setCancelable(true)
							.setMsg(getString(R.string.smartplug_mgr_notscanplug))
							.setPositiveButton(
									AddSocketActivity2.this
											.getString(R.string.smartplug_ok),
							...
							.setNegativeButton(
									AddSocketActivity2.this
											.getString(R.string.smartplug_cancel),
									new View.OnClickListener() {
										@Override
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setTitleRightButton(R.string.smartplug_refresh,
				R.drawable.title_btn_selector, this);
	...
	public class AddOnClickListener implements OnClickListener {
		...
		public void onClick(View view) {
			...
			if (PubDefine.SmartPlug_Connect_Mode.Internet == PubDefine.g_Connect_Mode) {
			...
			} else if (PubDefine.SmartPlug_Connect_Mode.Shake == PubDefine.g_Connect_Mode) { // 3��
																								// ҡһҡ
																								// ����UDPģʽ
				intent.setClass(AddSocketActivity2.this,
						AddSocketActivity3.class);
				...
				intent.putExtra("PLUGCOUNT", listView.getCount());
				intent.putExtra("CONNECT_MODE",
						"PubDefine.SmartPlug_Connect_Mode.Shake");
				startActivity(intent);
				finish();
			}
		}
	...
	public class MyAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			String productType = PubFunc
					.getProductTypeFromSSID(scanResult.SSID);
			...
			if ((deviceType == PubDefine.DEVICE_SMART_PLUG && productType == PubDefine.PRODUCT_PLUG)
				...
				img_devicetype.setImageResource(R.drawable.smp_plug_small);
			} else if (deviceType == PubDefine.DEVICE_SMART_SWITCH
					&& productType == PubDefine.PRODUCT_PLUG) { // 5_1
				img_devicetype.setImageResource(R.drawable.smp_plug_small);
			} else if (deviceType == PubDefine.DEVICE_SMART_SWITCH
					&& productType == PubDefine.PRODUCT_SMART_PLUG_AIRCON) { // 5_2
				img_devicetype.setImageResource(R.drawable.smp_plug_small);
			} else if (deviceType == PubDefine.DEVICE_SMART_GROWLIGHT
					&& productType == PubDefine.PRODUCT_PLUG) { // 12_1
	...
	public class UpdateTableTask extends AsyncTask<Void, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			...
			if ((deviceType == PubDefine.DEVICE_SMART_PLUG && productType == PubDefine.PRODUCT_PLUG)
				...
				intent.setClass(AddSocketActivity2.this,
						DetailKettleActivity.class);
			} else if (deviceType == PubDefine.DEVICE_SMART_CURTAIN) { // 3_1
				intent.setClass(AddSocketActivity2.this,
						DetailCurtainActivity.class);
			} else if (deviceType == PubDefine.DEVICE_SMART_WINDOW) {
				intent.setClass(AddSocketActivity2.this,
						DetailWindowActivity.class);
			} else if (deviceType == PubDefine.DEVICE_SMART_PLUG
					&& productType == PubDefine.PRODUCT_SMART_PLUG_AIRCON) { // 1_2
				intent.setClass(AddSocketActivity2.this,
						PlugDetailActivity.class);
