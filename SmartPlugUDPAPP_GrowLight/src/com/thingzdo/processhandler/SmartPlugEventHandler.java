...
public class SmartPlugEventHandler extends Handler {
	...
	private void registerEvent() {
		...
		// 红外场景
		mEventHandlerMaps.add(new SmartPlugEventHandlerMap(
				SmartPlugMessage.EVT_SP_AIRCON_ADDIRSCENE,
				new SmartPlugEventHandlerAddIRScene()));
		mEventHandlerMaps.add(new SmartPlugEventHandlerMap(
				SmartPlugMessage.EVT_SP_AIRCON_MODIFYIRSCENE,
				new SmartPlugEventHandlerModifyIRScene()));
		mEventHandlerMaps.add(new SmartPlugEventHandlerMap(
				SmartPlugMessage.EVT_SP_AIRCON_DELIRSCENE,
				new SmartPlugEventHandlerDeleteIRScene()));
		mEventHandlerMaps.add(new SmartPlugEventHandlerMap(
				SmartPlugMessage.EVT_SP_AIRCON_ENABLEIRSCENE,
				new SmartPlugEventHandlerEnableIRScene()));
		mEventHandlerMaps.add(new SmartPlugEventHandlerMap(
				SmartPlugMessage.EVT_SP_AIRCON_QUERYIRSCENE,
				new SmartPlugEventHandlerQueryIRScene()));

		// 场景
		mEventHandlerMaps.add(new SmartPlugEventHandlerMap(
				SmartPlugMessage.EVT_SP_ADDSCENE,
				new SmartPlugEventHandlerAddScene()));
		mEventHandlerMaps.add(new SmartPlugEventHandlerMap(
				SmartPlugMessage.EVT_SP_DELSCENE,
				new SmartPlugEventHandlerDeleteScene()));
		mEventHandlerMaps.add(new SmartPlugEventHandlerMap(
				SmartPlugMessage.EVT_SP_QUERYSCENE,
				new SmartPlugEventHandlerQueryScene()));
		mEventHandlerMaps.add(new SmartPlugEventHandlerMap(
				SmartPlugMessage.EVT_SP_APPLYSCENE,
				new SmartPlugEventHandlerApplyScene()));
		...
		// 智能电子秤
		mEventHandlerMaps.add(new SmartPlugEventHandlerMap(
				SmartPlugMessage.EVT_SP_QUERYWEIGHT,
				new SmartPlugEventHandlerGetWeight()));
		mEventHandlerMaps.add(new SmartPlugEventHandlerMap(
				SmartPlugMessage.EVT_SP_QUERYMOAPI,
				new SmartPlugEventHandlerGetMaopi()));
		...
		// 植物生长灯
		mEventHandlerMaps.add(new SmartPlugEventHandlerMap(
				SmartPlugMessage.EVT_SP_GROWLIGHT_QRY_STATUS,
				new SmartPlugEventHandlerGrowLightQryStatus()));
		mEventHandlerMaps.add(new SmartPlugEventHandlerMap(
		...
		mEventHandlerMaps.add(new SmartPlugEventHandlerMap(
				SmartPlugMessage.EVT_SP_GROWLIGHT_SET_CURTIME,
				new SmartPlugEventHandlerGrowLightSetCurTime()));
		mEventHandlerMaps.add(new SmartPlugEventHandlerMap(
				SmartPlugMessage.EVT_SP_GROWLIGHT_SET_WORKMODE,
				new SmartPlugEventHandlerGrowLightSetWorkMode()));
		mEventHandlerMaps.add(new SmartPlugEventHandlerMap(
				SmartPlugMessage.EVT_SP_GROWLIGHT_ADD_TIMETASK,
				new SmartPlugEventHandlerGrowLightAddTimeTask()));
		mEventHandlerMaps.add(new SmartPlugEventHandlerMap(
				SmartPlugMessage.EVT_SP_GROWLIGHT_DEL_TIMETASK,
				new SmartPlugEventHandlerGrowLightDelTimeTask()));
		mEventHandlerMaps.add(new SmartPlugEventHandlerMap(
				SmartPlugMessage.EVT_SP_GROWLIGHT_MOD_TIMETASK,
				new SmartPlugEventHandlerGrowLightModTimeTask()));
		mEventHandlerMaps.add(new SmartPlugEventHandlerMap(
				SmartPlugMessage.EVT_SP_GROWLIGHT_QRY_TIMETASK,
				new SmartPlugEventHandlerGrowLightQryTimeTask()));
		mEventHandlerMaps.add(new SmartPlugEventHandlerMap(
				SmartPlugMessage.EVT_SP_GROWLIGHT_QRY_SUNTIME,
				new SmartPlugEventHandlerGrowLightQrySunTime()));
		mEventHandlerMaps.add(new SmartPlugEventHandlerMap(
