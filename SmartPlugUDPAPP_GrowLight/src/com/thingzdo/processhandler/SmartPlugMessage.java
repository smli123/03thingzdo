...
public class SmartPlugMessage {
	...
	// 植物生长灯
	public static final String CMD_SP_GROWLIGHT_QRY_STATUS = "APPQRYGROWSTATUS";
	public static final String CMD_SP_GROWLIGHT_SET_BRIGHT = "APPSETGROWBRIGHT";
	public static final String CMD_SP_GROWLIGHT_QRY_TIMECURVE = "APPQRYGROWTIMECURVE";
	public static final String CMD_SP_GROWLIGHT_SET_TIMECURVE = "APPSETGROWTIMECURVE";
	...
	public static final String CMD_SP_GROWLIGHT_SET_TEMPERATURE = "APPSETGROWTEMPERATURE";
	public static final String CMD_SP_GROWLIGHT_SET_CURTIME = "APPSETGROWCURTIME";
	public static final String CMD_SP_GROWLIGHT_SET_WORKMODE = "APPSETGROWWORKMODE";
	public static final String CMD_SP_GROWLIGHT_ADD_TIMETASK = "APPADDGROWTIMETASK";
	public static final String CMD_SP_GROWLIGHT_DEL_TIMETASK = "APPDELGROWTIMETASK";
	public static final String CMD_SP_GROWLIGHT_MOD_TIMETASK = "APPMODGROWTIMETASK";
	public static final String CMD_SP_GROWLIGHT_QRY_TIMETASK = "APPQRYGROWTIMETASK";
	public static final String CMD_SP_GROWLIGHT_QRY_SUNTIME = "APPQRYGROWSUNTIME";
	public static final String CMD_SP_GROWLIGHT_SET_SUNTIME = "APPSETGROWSUNTIME";
