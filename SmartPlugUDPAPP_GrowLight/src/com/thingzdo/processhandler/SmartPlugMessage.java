...
public class SmartPlugMessage {
	...
	// 智能电子秤
	public static final String CMD_SP_STEELYARD_APPGETWEIGHT = "APPGET_WEIGHT";
	public static final String CMD_SP_STEELYARD_APPGETMAOPI = "APPGET_MAOPI";

	// 红外场景命令字
	public static final String CMD_SP_ADDIRSCENE = "APPADDIRSCENE";
	public static final String CMD_SP_MODIFYIRSCENE = "APPMODIFYIRSCENE";
	public static final String CMD_SP_DELIRSCENE = "APPDELIRSCENE";
	public static final String CMD_SP_ENABLEIRSCENE = "APPENABLEIRSCENE";
	public static final String CMD_SP_QUERYIRSCENE = "APPQUERYIRSCENE";

	// 场景命令字
	public static final String CMD_SP_ADDSCENE = "APPADDSCENE";
	public static final String CMD_SP_DELSCENE = "APPDELSCENE";
	public static final String CMD_SP_QUERYSCENE = "APPQRYSCENE";
	public static final String CMD_SP_APPLYSCENE = "APPAPPLYSCENE";
	...
	// 植物生长灯
	public static final String CMD_SP_GROWLIGHT_QRY_STATUS = "APPQRYGROWLIGHTSTATUS";
	public static final String CMD_SP_GROWLIGHT_SET_BRIGHT = "APPSETGROWLIGHTBRIGHT";
	public static final String CMD_SP_GROWLIGHT_QRY_TIMECURVE = "APPQRYGROWLIGHTTIMECURVE";
	public static final String CMD_SP_GROWLIGHT_SET_TIMECURVE = "APPSETGROWLIGHTTIMECURVE";
	public static final String CMD_SP_GROWLIGHT_QRY_TIMECURVEPOINT = "APPQRYCURVEPOINTS";
	public static final String CMD_SP_GROWLIGHT_SET_TIMECURVEPOINT = "APPSETCURVEPOINTS";
	public static final String CMD_SP_GROWLIGHT_SET_TEMPERATURE = "APPSETGROWLIGHTTEMPERATURE";
	public static final String CMD_SP_GROWLIGHT_SET_CURTIME = "APPSETGROWLIGHTCURTIME";
	public static final String CMD_SP_GROWLIGHT_SET_WORKMODE = "APPSETGROWLIGHTWORKMODE";
	public static final String CMD_SP_GROWLIGHT_ADD_TIMETASK = "APPADDGROWLIGHTTIMETASK";
	public static final String CMD_SP_GROWLIGHT_DEL_TIMETASK = "APPDELGROWLIGHTTIMETASK";
	public static final String CMD_SP_GROWLIGHT_MOD_TIMETASK = "APPMODGROWLIGHTTIMETASK";
	public static final String CMD_SP_GROWLIGHT_QRY_TIMETASK = "APPQRYGROWLIGHTTIMETASK";
	public static final String CMD_SP_GROWLIGHT_QRY_SUNTIME = "APPQRYGROWLIGHTSUNTIME";
	public static final String CMD_SP_GROWLIGHT_SET_SUNTIME = "APPSETGROWLIGHTSUNTIME";
	...
	public static final int EVT_SP_AIRCON_ADDIRSCENE = 220;
	public static final int EVT_SP_AIRCON_MODIFYIRSCENE = 221;
	public static final int EVT_SP_AIRCON_DELIRSCENE = 222;
	public static final int EVT_SP_AIRCON_ENABLEIRSCENE = 223;
	public static final int EVT_SP_AIRCON_QUERYIRSCENE = 224;
	...
	public static final int EVT_SP_ADDSCENE = 235;
	public static final int EVT_SP_DELSCENE = 236;
	public static final int EVT_SP_QUERYSCENE = 237;
	public static final int EVT_SP_APPLYSCENE = 238;

	public static final int EVT_SP_QUERYWEIGHT = 239;
	public static final int EVT_SP_QUERYMOAPI = 240;

	// 植物生长灯
	public static final int EVT_SP_GROWLIGHT_QRY_STATUS = 241;
	public static final int EVT_SP_GROWLIGHT_SET_BRIGHT = 242;
	public static final int EVT_SP_GROWLIGHT_QRY_TIMECURVE = 243;
	public static final int EVT_SP_GROWLIGHT_SET_TIMECURVE = 244;
	public static final int EVT_SP_GROWLIGHT_SET_TEMPERATURE = 245;
	public static final int EVT_SP_GROWLIGHT_SET_CURTIME = 246;
	public static final int EVT_SP_GROWLIGHT_SET_WORKMODE = 247;
	public static final int EVT_SP_GROWLIGHT_ADD_TIMETASK = 248;
	public static final int EVT_SP_GROWLIGHT_DEL_TIMETASK = 249;
	public static final int EVT_SP_GROWLIGHT_MOD_TIMETASK = 250;
	public static final int EVT_SP_GROWLIGHT_QRY_TIMETASK = 251;
	public static final int EVT_SP_GROWLIGHT_QRY_SUNTIME = 252;
	public static final int EVT_SP_GROWLIGHT_SET_SUNTIME = 253;
	public static final int EVT_SP_GROWLIGHT_QRY_TIMECURVEPOINT = 254;
	public static final int EVT_SP_GROWLIGHT_SET_TIMECURVEPOINT = 255;
	...
	static {
		...
		mEventCommand.put(CMD_SP_ADDIRSCENE, EVT_SP_AIRCON_ADDIRSCENE);
		mEventCommand.put(CMD_SP_MODIFYIRSCENE, EVT_SP_AIRCON_MODIFYIRSCENE);
		mEventCommand.put(CMD_SP_DELIRSCENE, EVT_SP_AIRCON_DELIRSCENE);
		mEventCommand.put(CMD_SP_ENABLEIRSCENE, EVT_SP_AIRCON_ENABLEIRSCENE);
		mEventCommand.put(CMD_SP_QUERYIRSCENE, EVT_SP_AIRCON_QUERYIRSCENE);

		mEventCommand.put(CMD_SP_ADDSCENE, EVT_SP_ADDSCENE);
		mEventCommand.put(CMD_SP_DELSCENE, EVT_SP_DELSCENE);
		mEventCommand.put(CMD_SP_QUERYSCENE, EVT_SP_QUERYSCENE);
		mEventCommand.put(CMD_SP_APPLYSCENE, EVT_SP_APPLYSCENE);
		...
		// STEELYARD
		mEventCommand.put(CMD_SP_STEELYARD_APPGETWEIGHT, EVT_SP_QUERYWEIGHT);
		mEventCommand.put(CMD_SP_STEELYARD_APPGETMAOPI, EVT_SP_QUERYMOAPI);
		...
		// 植物生长灯
		mEventCommand.put(CMD_SP_GROWLIGHT_QRY_STATUS,
				EVT_SP_GROWLIGHT_QRY_STATUS);
		mEventCommand.put(CMD_SP_GROWLIGHT_SET_BRIGHT,
				EVT_SP_GROWLIGHT_SET_BRIGHT);
		mEventCommand.put(CMD_SP_GROWLIGHT_QRY_TIMECURVE,
				EVT_SP_GROWLIGHT_QRY_TIMECURVE);
		mEventCommand.put(CMD_SP_GROWLIGHT_SET_TIMECURVE,
				EVT_SP_GROWLIGHT_SET_TIMECURVE);
		mEventCommand.put(CMD_SP_GROWLIGHT_SET_TEMPERATURE,
				EVT_SP_GROWLIGHT_SET_TEMPERATURE);
		mEventCommand.put(CMD_SP_GROWLIGHT_QRY_TIMECURVEPOINT,
				EVT_SP_GROWLIGHT_QRY_TIMECURVEPOINT);
		mEventCommand.put(CMD_SP_GROWLIGHT_SET_TIMECURVEPOINT,
				EVT_SP_GROWLIGHT_SET_TIMECURVEPOINT);
		mEventCommand.put(CMD_SP_GROWLIGHT_SET_TEMPERATURE,
				EVT_SP_GROWLIGHT_SET_TEMPERATURE);
		mEventCommand.put(CMD_SP_GROWLIGHT_SET_CURTIME,
				EVT_SP_GROWLIGHT_SET_CURTIME);
		mEventCommand.put(CMD_SP_GROWLIGHT_SET_WORKMODE,
				EVT_SP_GROWLIGHT_SET_WORKMODE);
		mEventCommand.put(CMD_SP_GROWLIGHT_ADD_TIMETASK,
				EVT_SP_GROWLIGHT_ADD_TIMETASK);
		mEventCommand.put(CMD_SP_GROWLIGHT_DEL_TIMETASK,
				EVT_SP_GROWLIGHT_DEL_TIMETASK);
		mEventCommand.put(CMD_SP_GROWLIGHT_MOD_TIMETASK,
				EVT_SP_GROWLIGHT_MOD_TIMETASK);
		mEventCommand.put(CMD_SP_GROWLIGHT_QRY_TIMETASK,
				EVT_SP_GROWLIGHT_QRY_TIMETASK);
		mEventCommand.put(CMD_SP_GROWLIGHT_QRY_SUNTIME,
				EVT_SP_GROWLIGHT_QRY_SUNTIME);
		mEventCommand.put(CMD_SP_GROWLIGHT_SET_SUNTIME,
				EVT_SP_GROWLIGHT_SET_SUNTIME);
	...
	static {
		...
		mCommandAction.put(CMD_SP_ADDIRSCENE,
				PubDefine.PLUG_AIRCON_ADDIRSCENE_ACTION);
		mCommandAction.put(CMD_SP_MODIFYIRSCENE,
				PubDefine.PLUG_AIRCON_MODIFYIRSCENE_ACTION);
		mCommandAction.put(CMD_SP_DELIRSCENE,
				PubDefine.PLUG_AIRCON_DELIRSCENE_ACTION);
		mCommandAction.put(CMD_SP_ENABLEIRSCENE,
				PubDefine.PLUG_AIRCON_ENABLEIRSCENE_ACTION);
		mCommandAction.put(CMD_SP_QUERYIRSCENE,
				PubDefine.PLUG_AIRCON_QUERYIRSCENE_ACTION);

		mCommandAction.put(CMD_SP_ADDSCENE, PubDefine.PLUG_ADDSCENE_ACTION);
		mCommandAction.put(CMD_SP_DELSCENE, PubDefine.PLUG_DELSCENE_ACTION);
		mCommandAction.put(CMD_SP_QUERYSCENE, PubDefine.PLUG_QUERYSCENE_ACTION);
		mCommandAction.put(CMD_SP_APPLYSCENE, PubDefine.PLUG_APPLYSCENE_ACTION);
		...
		// STEELYARD
		mCommandAction.put(CMD_SP_STEELYARD_APPGETWEIGHT,
				PubDefine.PLUG_STEELYARD_GETWEIGHT_ACTION);
		mCommandAction.put(CMD_SP_STEELYARD_APPGETMAOPI,
		...
		// 植物生长灯
		mCommandAction.put(CMD_SP_GROWLIGHT_QRY_STATUS,
				PubDefine.PLUG_GROWLIGHT_QRY_STATUS_ACTION);
		mCommandAction.put(CMD_SP_GROWLIGHT_SET_BRIGHT,
				PubDefine.PLUG_GROWLIGHT_SET_BRIGHT_ACTION);
		mCommandAction.put(CMD_SP_GROWLIGHT_QRY_TIMECURVE,
				PubDefine.PLUG_GROWLIGHT_QRY_TIMECURVE_ACTION);
		mCommandAction.put(CMD_SP_GROWLIGHT_SET_TIMECURVE,
				PubDefine.PLUG_GROWLIGHT_SET_TIMECURVE_ACTION);
		mCommandAction.put(CMD_SP_GROWLIGHT_QRY_TIMECURVEPOINT,
				PubDefine.PLUG_GROWLIGHT_QRY_TIMECURVEPOINT_ACTION);
		mCommandAction.put(CMD_SP_GROWLIGHT_SET_TIMECURVEPOINT,
				PubDefine.PLUG_GROWLIGHT_SET_TIMECURVEPOINT_ACTION);

		mCommandAction.put(CMD_SP_GROWLIGHT_SET_TEMPERATURE,
				PubDefine.PLUG_GROWLIGHT_SET_TEMPERATURE_ACTION);
		mCommandAction.put(CMD_SP_GROWLIGHT_SET_CURTIME,
				PubDefine.PLUG_GROWLIGHT_SET_CUR_TIME_ACTION);
		mCommandAction.put(CMD_SP_GROWLIGHT_SET_WORKMODE,
				PubDefine.PLUG_GROWLIGHT_SET_WORK_MODE_ACTION);
		mCommandAction.put(CMD_SP_GROWLIGHT_ADD_TIMETASK,
				PubDefine.PLUG_GROWLIGHT_ADD_TIMETASK_ACTION);

		mCommandAction.put(CMD_SP_GROWLIGHT_DEL_TIMETASK,
				PubDefine.PLUG_GROWLIGHT_DEL_TIMETASK_ACTION);
		mCommandAction.put(CMD_SP_GROWLIGHT_MOD_TIMETASK,
				PubDefine.PLUG_GROWLIGHT_MOD_TIMETASK_ACTION);
		mCommandAction.put(CMD_SP_GROWLIGHT_QRY_TIMETASK,
				PubDefine.PLUG_GROWLIGHT_QRY_TIMETASK_ACTION);

		mCommandAction.put(CMD_SP_GROWLIGHT_QRY_SUNTIME,
				PubDefine.PLUG_GROWLIGHT_QRY_SUNTIME_ACTION);
		mCommandAction.put(CMD_SP_GROWLIGHT_SET_SUNTIME,
