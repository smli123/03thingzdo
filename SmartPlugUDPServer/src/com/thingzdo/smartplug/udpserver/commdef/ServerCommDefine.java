...
public class ServerCommDefine {
	...
	// 植物生长灯
	public final static String APP_GROWLIGHT_QRY_STATUS_MSG_HEADER		= "APPQRYGROWSTATUS";
	public final static String APP_GROWLIGHT_SET_BRIGHT_MSG_HEADER		= "APPSETGROWBRIGHT";
	public final static String APP_GROWLIGHT_QRY_TIMECURVE_MSG_HEADER		= "APPQRYGROWTIMECURVE";
	public final static String APP_GROWLIGHT_SET_TIMECURVE_MSG_HEADER		= "APPSETGROWTIMECURVE";
	public final static String APP_GROWLIGHT_SET_TEMPERATURE_MSG_HEADER		= "APPSETGROWTEMPERATURE";
	public final static String APP_GROWLIGHT_SET_CURTIME_MSG_HEADER		= "APPSETGROWCURTIME";
	public final static String APP_GROWLIGHT_SET_WORKMODE_MSG_HEADER		= "APPSETGROWWORKMODE";
	public final static String APP_GROWLIGHT_ADD_TIMETASK_MSG_HEADER		= "APPADDGROWTIMETASK";
	public final static String APP_GROWLIGHT_DEL_TIMETASK_MSG_HEADER		= "APPDELGROWTIMETASK";
	public final static String APP_GROWLIGHT_MOD_TIMETASK_MSG_HEADER		= "APPMODGROWTIMETASK";
	public final static String APP_GROWLIGHT_QRY_TIMETASK_MSG_HEADER		= "APPQRYGROWTIMETASK";
	public final static String APP_GROWLIGHT_QRY_SUNTIME_MSG_HEADER		= "APPQRYGROWSUNTIME";
	public final static String APP_GROWLIGHT_SET_SUNTIME_MSG_HEADER		= "APPSETGROWSUNTIME";
	public final static String APP_GROWLIGHT_QRY_TIMECURVEPOINT_MSG_HEADER		= "APPQRYCURVEPOINTS";
	public final static String APP_GROWLIGHT_SET_TIMECURVEPOINT_MSG_HEADER		= "APPSETCURVEPOINTS";

	public final static String GROWLIGHT_QRY_STATUS_MSG_HEADER		= "QRYGROWSTATUS";
	public final static String GROWLIGHT_SET_BRIGHT_MSG_HEADER		= "SETGROWBRIGHT";
	public final static String GROWLIGHT_QRY_TIMECURVE_MSG_HEADER		= "QRYGROWTIMECURVE";
	public final static String GROWLIGHT_SET_TIMECURVE_MSG_HEADER		= "SETGROWTIMECURVE";
	public final static String GROWLIGHT_SET_TEMPERATURE_MSG_HEADER		= "SETGROWTEMPERATURE";
	public final static String GROWLIGHT_SET_CURTIME_MSG_HEADER		= "SETGROWCURTIME";
	public final static String GROWLIGHT_SET_WORKMODE_MSG_HEADER		= "SETGROWWORKMODE";
	public final static String GROWLIGHT_ADD_TIMETASK_MSG_HEADER		= "ADDGROWTIMETASK";
	public final static String GROWLIGHT_DEL_TIMETASK_MSG_HEADER		= "DELGROWTIMETASK";
	public final static String GROWLIGHT_MOD_TIMETASK_MSG_HEADER		= "MODGROWTIMETASK";
	public final static String GROWLIGHT_QRY_TIMETASK_MSG_HEADER		= "QRYGROWTIMETASK";
	public final static String GROWLIGHT_QRY_SUNTIME_MSG_HEADER		= "QRYGROWSUNTIME";
	public final static String GROWLIGHT_SET_SUNTIME_MSG_HEADER		= "SETGROWSUNTIME";
	public final static String GROWLIGHT_QRY_TIMECURVEPOINT_MSG_HEADER		= "QRYCURVEPOINTS";
	public final static String GROWLIGHT_SET_TIMECURVEPOINT_MSG_HEADER		= "SETCURVEPOINTS";
